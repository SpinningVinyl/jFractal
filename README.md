...
It can be used to visualise the Mandelbrot set or the Julia set. Since the Julia set really depends on the constant part of the equation, this app allows you to change it by selecting the appropriate option.

The color offset slider allows you to change the colours of the output. (The value of the slider is added to the hue component of the colours generated by the application.)
